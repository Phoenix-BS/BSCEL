...
map.customData.environment.push(
    ...
    // Fence but LOOOOOOONGer

    // {
    //     geometry: { type: "Cube", material: "WoodMaterial" },
    //     position: [12.2, -0.1, 43],
    //     rotation: [65, -10, 0],
    //     scale: [0.2, 6.75, 0.2]
    // },
    // {
    //     geometry: { type: "Cube", material: "WoodMaterial" },
    //     position: [11.65, -0.1, 46],
    //     rotation: [65, -10, 0],
    //     scale: [0.2, 6.75, 0.2]
    // },
    // {
